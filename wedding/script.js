...
const translations = {
  ...
  pl: {
    ...
    serenataText: "Kilka dni przed ślubem oficjalnie rozpoczniemy uroczystości ślubne tradycyjną serenadą w strojach ludowych. Tańce, hulanki i swawole — nie może Cię zabraknąć! O szczegóły pytaj Pana Młodego… i pamiętaj: to tajemnica! 😉",
    ...
    vodkaTitle: "Wódka", vodkaText: " 'Alla salute!' Na zdrowie! Przygotuj się na polski toast i na śpiewanie “Gorzka wódka!” za każdym razem, gdy będziesz chcieć zachęcić Parę Młodą do pocałunku.",
